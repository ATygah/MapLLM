...
class GPT2XL:
    """
    Implementation of GPT2-XL model using the LLM framework.
    """
    def __init__(
        self,
        noc_rows: int = 400,
        ...
        self.num_heads = self.config.get('num_heads', 25)
        self.num_layers = self.config.get('num_layers', 48)
    ...
    def _build_model(self):
        """Build the complete GPT2-XL model structure."""
