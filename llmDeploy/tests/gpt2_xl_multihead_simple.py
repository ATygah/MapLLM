...
def test_multihead_attention_simple():
    ...
    log_dir = os.path.join(os.path.dirname(__file__), "../final_traces/gpt2_xl/multihead_simple")
    os.makedirs(log_dir, exist_ok=True)
    log_file = os.path.join(log_dir, f"gpt2_xl_multihead_simple_{timestamp}.log")
    ...
    with open(log_file, "w") as f:
        ...
        try:
            ...
            try:
                timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
                traffic_filename = f"gpt2_xl_multihead_simple_{timestamp}.txt"
                traces_dir = os.path.join(os.path.dirname(__file__), "../final_traces/gpt2_xl/multihead_simple")
