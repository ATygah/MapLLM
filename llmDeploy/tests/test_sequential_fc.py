...
def test_sequential_fc():
    ...
    print(f"Active PEs in fc2: {fc2.active_pes}")
    ...
    if not traffic_table.empty:
        ...
        # Print full traffic table with network information
    ...
    log_file = os.path.join(log_dir, f"sequential_fc_test_{timestamp}.log")
    
    with open(log_file, "w") as f:
        f.write("===== Sequential FC Networks Test =====\n\n")
        ...
        if not traffic_table.empty:
            ...
            # Log specific network-to-network traffic
            network_traffic = {
                "fc1_to_fc2": 0
            }
